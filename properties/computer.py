...
from properties.models import RealEstateProperty
...
class Calculator:
    ...
    def compute_real_estate_agency_fees(self, agency_rate: float = None) -> float:
        """
        Compute fees collected by real estate agency.

        Args:
            agency_rate: (Optional) Tax rates asked by real estate agency.
        """
    ...
    def compute_insurance_per_year(real) -> float:
